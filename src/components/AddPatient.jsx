...
function AddPatient(){
    ...
    const onSubmit = (data) => {
        ...
        addPatient(email, dob, first_name, last_name)
          .then((data) => {
            if (data.errors) {
    ...
    return(
        <>
            ...
            <div style={divStyle}>
                ...
                <p style={descriptionStyle}>Please enter the necessary information for your patient below.</p>
            </div>
            <Container style={{ height: "100vh", maxWidth: "1250px" }} className="bg-white overflow-auto px-5">
                <Row className="">
